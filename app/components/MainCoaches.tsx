    ...
    <div className="relative w-full h-[400px] overflow-hidden">
      ...
      >
       ...
       {!isLeftExpanded&&( <div className="absolute bottom-4 right-4 w-1/2 text-white">
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla dolorem, provident veritatis quos, nesciunt, officia explicabo consequuntur doloribus eaque saepe quidem! Accusamus, culpa? Molestiae soluta veniam earum, ullam adipisci ratione.</p>
        </div>)}
      </div>
    </div>
  );
